...
public class SecondCountry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_second_country);
        ...
        yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                /*
                    If the user finds their country, add 2 to the "key"
                    when going to the next Activity attach the "key" value with the intent
                    go to next activity
                 */
                intValue[0] = intValue[0] + 2;
                Intent intent = new Intent(getApplicationContext(), ThirdCountry.class);
